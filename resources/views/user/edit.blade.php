                    ...
                    <form method="POST" action="{{ route('admin.user.update', $data->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body row">
                            ...
                            <div class="col-4 mb-3">
                                ...
                                <input name="birthday" type="date" class="form-control" value="{{ old('birthday') ?? $data->birthday }}"
                            ...
                            <div class="col-4 mb-3">
                                ...
                                <input name="phone_number" type="text" class="form-control"
                                    value="{{ old('phone_number') ?? $data->phone_number }}" placeholder="Nhập số điện thoại">
