                        ...
                        <div class="card-body row">
                            <div class="col-3 mb-3">
                                ...
                                <input name="name" type="text" class="form-control"
                                    value="{{ old('name') ?? $data->name }}" placeholder="Nhập tên ứng viên">
                                {!! $errors->first('name', '<span class="text-danger">:message</span>') !!}
                            </div>
                            <div class="col-3 mb-3">
                                <label class="form-label">Ngày sinh <span class="text-danger">*</span></label>
                                <input name="birthday" type="date" class="form-control"
                                    value="{{ old('birthday') ?? $data->birthday }}" placeholder="Nhập ngày sinh">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="received_time" type="date" class="form-control"
                                    value="{{ old('received_time') ?? $data->received_time }}"
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="relationship_note" type="text" class="form-control"
                                    value="{{ old('relationship_note') ?? $data->relationship_note }}"
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="address_detail" type="text" class="form-control"
                                    value="{{ old('address_detail') ?? $data->address_detail }}" placeholder="Nhập nơi ở">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="major" type="text" class="form-control"
                                    value="{{ old('major') ?? $data->major }}" placeholder="Nhập nơi đào tạo">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="training_place" type="text" class="form-control"
                                    value="{{ old('training_place') ?? $data->training_place }}"
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="english" type="text" class="form-control"
                                    value="{{ old('english') ?? $data->english }}">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="other_language" type="text" class="form-control"
                                    value="{{ old('other_language') ?? $data->other_language }}"
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="other_software" type="text" class="form-control"
                                    value="{{ old('other_software') ?? $data->other_software }}"
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="info1" type="text" class="form-control"
                                    value="{{ old('info1') ?? $data->info1 }}" placeholder="Nhập thông tin tham chiếu 1">
                                {!! $errors->first('info1', '<span class="text-danger">:message</span>') !!}
                            </div>
                            <div class="col-3 mb-3">
                                <label class="form-label">Thông tin tham chiếu 2</label>
                                <input name="info2" type="text" class="form-control"
                                    value="{{ old('info2') ?? $data->info2 }}" placeholder="Nhập thông tin tham chiếu 2">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="interview_date" type="date" class="form-control"
                                    value="{{ old('interview_date') ?? $data->interview_date }}">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="interview_comment" type="text" class="form-control"
                                    value="{{ old('interview_comment') ?? $data->interview_comment }}"
                                    placeholder="Nhập">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="interview_date0" type="date" class="form-control"
                                    value="{{ old('interview_date0') ?? $data->interview_date0 }}" placeholder="Nhập">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="interview_comment0" type="text" class="form-control"
                                    value="{{ old('interview_comment0') ?? $data->interview_comment0 }}"
                                    placeholder="Nhập">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="interview_date1" type="date" class="form-control"
                                    value="{{ old('interview_date1') ?? $data->interview_date1 }}" placeholder="Nhập">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="interview_comment1" type="text" class="form-control"
                                    value="{{ old('interview_comment1') ?? $data->interview_comment1 }}"
                                    placeholder="Nhập">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="interview_date2" type="date" class="form-control"
                                    value="{{ old('interview_date2') ?? $data->interview_date2 }}" placeholder="Nhập">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="interview_comment2" type="text" class="form-control"
                                    value="{{ old('interview_comment2') ?? $data->interview_comment2 }}"
                                    placeholder="Nhập">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="interview_date3" type="date" class="form-control"
                                    value="{{ old('interview_date3') ?? $data->interview_date3 }}" placeholder="Nhập">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="interview_comment3" type="text" class="form-control"
                                    value="{{ old('interview_comment3') ?? $data->interview_comment3 }}"
                                    placeholder="Nhập">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <input name="score" type="text" class="form-control"
                                    value="{{ old('score') ?? $data->score }}" placeholder="Nhập">
                            </div>
                        </div>
